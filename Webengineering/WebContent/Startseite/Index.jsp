    ...
    <div class="collapse navbar-collapse" id="collapsibleNavbar">
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="#asd" id="navbardrop1" data-toggle="dropdown">Gruppen <i
            ...
            <!-- Zahlungen -->
            <li class="nav-item">
                <a class="nav-link" href="#asd">Zahlungen <i class="fas fa-receipt"></i></a>
            </li>
        </ul>
        <!-- Navbar Items Rechts-->
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="#asd" id="navbardrop2" data-toggle="dropdown">Benutzer <i
