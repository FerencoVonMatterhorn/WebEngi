...
<body>
	...
	<div class="collapse navbar-collapse" id="collapsibleNavbar">
		<ul class="navbar-nav">
			<c:choose>
				...
				<c:otherwise>
					...
					<li class="nav-item"><a class="nav-link active" href="#">Gruppen <i class="fas fa-users"></i>
					</a></li>
		...
		<ul class="navbar-nav ml-auto">
			<c:choose>
				<c:when test="${empty userID}">
					<li class="nav-item"><a class="nav-link" href="../official/register.jsp">Registrieren <i class="fas fa-sign-in-alt"></i></a></li>
				</c:when>
				<c:otherwise>
			...
			<div class="backgroundMid">
				<div class="container ">
					<div class="overviewHeader">
						...
						<p>Hier ist eine Übersicht aller Gruppen, an denen sie Teilhaben</p>
						...
						<div class="row justify-content-center">
							...
							<c:forEach items="${groupOverView.groups}" var="group">
								<div class="widget col-lg-10">
									...
									<button type="submit" onclick="setGroupID(${group.getGroupID()})" class="btn btn-success">Mehr anzeigen</button>
								</div>
							</c:forEach>
						</div>
					</form>
