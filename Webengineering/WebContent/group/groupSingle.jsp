				...
				<div class="container">
					...
					<div class="widget justify-content-center">
						...
						<form action="../payment/MonthlyPayment">
							<input type="hidden" name="monthlyPaymentID" id="monthlyPaymentID" />
							<c:forEach items="${singleGroup.getMonthlyPayments() }" var="monthlyPayment">
								<p class="singlePaymentFromOverview">
									...
									<br> <br>
									<button class="btn btn-success" type="submit" onclick="setMonthlyPaymentID(${monthlyPayment.getMonthlyPaymentID()})">Zur
										Zahlung</button>
									<br> <br>
								</p>
							</c:forEach>
				...
				<div class="modal fade" id="newPaymentModal">
					<form name="createPayment" action="createPayment" method="POST" autocomplete="off">
						<div class="modal-dialog">
							<input type="hidden" name="groupID" value="${singleGroup.getGroupID()}" />
