...
<jsp:useBean id="userPojo" class="main.java.pojos.UserPojo"
	scope="session"></jsp:useBean>
<jsp:useBean id="groupPojo" class="main.java.pojos.GroupPojo"
	scope="session"></jsp:useBean>
					...
					<div class="overviewHeader">
						<div class="row ml-2">
							<div class="mx-left ">
								...
								<p>Hier ist ein überblick über deine letzte Zahlung und top
									Gruppe.</p>
								<p style="margin-top: -0.6rem">Du kannst hier auch eine
									Zahlung erstellen.</p>
							</div>
						</div>
					</div>
				...
				<div class="row m-5">
					<div class="text-center mx-auto">
						<button class="btn btn-success mr-5" type="button"
							data-toggle="modal" data-target="#newGroupModal">Neue
							Gruppe</button>
						<!-- modal gruppe start -->
									...
									<div class="modal-content">
										...
										<div class="modal-header">
											...
											<button type="button" class="close" data-dismiss="modal"
												onclick="clearGroupModal()">&times;</button>
										</div>
										<!-- Modal body -->
										<div class="modal-body">
											<div class="form-group">
												<label for="groupName">Gruppen Name:</label> <input
											...
											<div class="form-group">
												...
												<textarea class="form-control" id="groupDescription"
													name="groupDescription"></textarea>
											</div>
											<div class="form-group">
										...
										<div class="modal-footer">
											<button type="button" class="btn btn-danger"
												data-dismiss="modal" onclick="clearGroupModal()">Abbrechen</button>
											<button type="submit" class="btn btn-primary">Gruppe
												erstellen</button>
										</div>
									</div>
								</div>
