		...
		<ul class="navbar-nav">
			<c:choose>
				...
				<c:otherwise>
					...
					<li class="nav-item"><a class="nav-link active" href="#">Zahlungen <i class="fas fa-receipt"></i>
					</a></li>
				</c:otherwise>
			</c:choose>
		</ul>
			...
			<div class="backgroundMid">
				<div class="container ">
					<div class="overviewHeader">
						...
						<p>Hier ist eine Übersicht aller Zahlungen, an denen sie Teilhaben</p>
					</div>
						...
						<div class="row justify-content-center">
							...
							<c:forEach items="${paymentOverview.payments}" var="payment">
								<div class="widget">
									...
									<button class="paymentBtn btn btn-success" type="submit" onclick="setPaymentID(${payment.getPaymentID()})">Zur
										Zahlung</button>
								</div>
							</c:forEach>
						</div>
						...
						<form>
							<ul class="pagination">
								...
								<c:forEach begin="1" end="${paymentOverview.pages}" varStatus="loop">
									<li class="page-item"><button type="submit" class="page-link" onclick="setPageSite(${loop.index})">
