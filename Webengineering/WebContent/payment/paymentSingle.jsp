...
<jsp:useBean id="payment" class="main.java.pojos.PaymentPojo" scope="session"></jsp:useBean>
<jsp:useBean id="singlePaymentBean" class="main.java.beans.SinglePaymentBean" scope="session"></jsp:useBean>
				...
				<div class="container">
					...
					<div class="row col-10 mx-auto mt-5 mb-5">
						<table class="table table-striped bg-dark text-white">
							...
							<tbody>
								<c:forEach items="${singlePaymentBean.paymentToUserPojosList}" var="paymentToUser">
									<tr>
